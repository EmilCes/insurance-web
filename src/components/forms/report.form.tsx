        ...
        <>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    {/* Sección de Vista para Ajustador */}
                    {(role === "Ajustador" && mode === "view") && (
                        <>
                            <div className="flex flex-col mt-4 mb-4">
                    ...
                    {/* Sección de Póliza e Imágenes y Ubicación */}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div className="p-4 border-lightGray border-[1px] rounded-md flex justify-center items-center h-52 w-full">
                                                <ImageUpload
                                                    urls={imageUrls}
                                                    readOnly={isReadOnly}
                                                    onFilesChange={(files) => {
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex-1">
                                        <FormLabel>Ubicación</FormLabel>
                                        <FormControl className="flex-1">
                                            <div className="p-4 border-lightGray border-[1px] rounded-md flex justify-center items-center h-52 w-full relative">
                                                {showMap && (
                                                    <MapWrapper
                                                        onLocationSelect={onLocationSelect}
                                                        initialLatitude={form.getValues('location.latitude')}
                    ...
                    {/* Datos de Conductores Involucrados */}
                    <div className="flex flex-col">
                        <div>
