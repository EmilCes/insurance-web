            ...
            {isLoading ? (<Loading></Loading>) : (<>
                <div className='grid grid-cols-1 md:grid-cols-3'>
                    <div className='col-span-2'>
                        ...
                        <h3 className="text-alternGray font-semibold text-xl">Estado: <span className="text-lightBlue">??</span></h3>
                    </div>
                ...
                <div className='border-solid border border-slate-400 rounded-lg py-8 px-8 mt-6'>
                    ...
                    <div className='mt-4 px-6 grid grid-cols-2 border-solid border-b border-slate-400 pb-4'>
                        <div className='border-solid border-r border-slate-400'>
                            ...
                            <p className='font-semibold'>Desde el {new Date(policyData?.startDate ? policyData?.startDate : "0").toLocaleDateString()}</p>
                            <p className='font-semibold'>Desde el ??</p>
                        </div>
