    ...
    return (
        <>
            <div className='flex items-center justify-center flex-col h-full border-slate-300 border rounded-xl m-4 p-4' >
                ...
                ></div>
                <h1 className='text-xl font-semibold mb-2 text-darkBlue'>Todavía no hay planes de póliza registrados</h1>
                <h2 className='text-alternGray'>Cuando cree una, se mostrará aquí</h2>
                <Button
