    ...
    return (
        <>
            <div className='flex items-center justify-center flex-col h-full border-slate-300 border rounded-xl m-4 p-4' >
                ...
                <h2 className='text-alternGray md:w-4/5 text-center'>No encontramos ninguna coincidencia con los planes de póliza registrados, por favor intente de nuevo con otras opciones</h2>
                <Button
